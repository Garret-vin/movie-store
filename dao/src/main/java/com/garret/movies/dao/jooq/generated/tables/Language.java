...
public class Language extends TableImpl<LanguageRecord> {
    ...
    private static final long serialVersionUID = -1560331555;

    /**
     * The reference instance of <code>movieStore.language</code>
     */
    ...
    /**
     * The column <code>movieStore.language.id</code>.
     */
    ...
    /**
     * The column <code>movieStore.language.value</code>.
     */
    public final TableField<LanguageRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * Create a <code>movieStore.language</code> table reference
     */
    public Language() {
    ...
    /**
     * Create an aliased <code>movieStore.language</code> table reference
     */
