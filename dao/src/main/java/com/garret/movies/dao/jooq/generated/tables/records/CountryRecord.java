...
public class CountryRecord extends UpdatableRecordImpl<CountryRecord> implements Record2<Long, String> {
    ...
    private static final long serialVersionUID = 1945860137;

    /**
     * Setter for <code>movieStore.country.id</code>.
     */
    ...
    /**
     * Getter for <code>movieStore.country.id</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>movieStore.country.name</code>.
     */
    ...
    /**
     * Getter for <code>movieStore.country.name</code>.
     */
     ...
     */
    public CountryRecord(Long id, String name) {
        super(Country.COUNTRY);
