...
public class LanguageRecord extends UpdatableRecordImpl<LanguageRecord> implements Record2<Long, String> {
    ...
    private static final long serialVersionUID = -1343427045;
    ...
    /**
     * Setter for <code>movieStore.language.value</code>.
     */
    ...
    /**
     * Getter for <code>movieStore.language.value</code>.
     */
     ...
     */
    public LanguageRecord(Long id, String value) {
        super(Language.LANGUAGE);
