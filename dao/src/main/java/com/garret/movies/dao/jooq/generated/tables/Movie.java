...
public class Movie extends TableImpl<MovieRecord> {
    ...
    private static final long serialVersionUID = -1392522333;
     ...
     */
    public final TableField<MovieRecord, String> IMDB_ID = createField("imdb_id", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final TableField<MovieRecord, String> RUNTIME = createField("runtime", org.jooq.impl.SQLDataType.VARCHAR(25), this, "");
     ...
     */
    public final TableField<MovieRecord, String> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(10), this, "");
