...
public class MovieGenres extends TableImpl<MovieGenresRecord> {
    ...
    private static final long serialVersionUID = 89273824;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MOVIE_GENRES_GENRES_ID, Indexes.MOVIE_GENRES_MOVIE_GENRES_INDEX);
    }
     ...
     */
    @Override
    public List<UniqueKey<MovieGenresRecord>> getKeys() {
        return Arrays.<UniqueKey<MovieGenresRecord>>asList(Keys.KEY_MOVIE_GENRES_GENRES_ID);
    }
